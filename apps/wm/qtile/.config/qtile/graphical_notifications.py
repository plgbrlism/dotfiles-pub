...
class Notifier(configurable.Configurable):
    ...
    def __init__(self, **config) -> None:
        ...
        self._scroll_popup: Popup | None = None
    ...
    def _send(
        self, notif: Notification, popup: Popup, timeout: int | None = None
    ) -> None:
        """
    ...
    def _close(self, popup: Popup, nid: int | None = None, reason=1) -> None:
        """
    ...
    def _load_icon(self, notif: Notification) -> tuple[ImageSurface, int] | None:
